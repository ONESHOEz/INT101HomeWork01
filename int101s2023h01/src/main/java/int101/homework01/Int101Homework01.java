...
public class Int101Homework01 {
    ...
    static void work01Answer(boolean b1, boolean b2, boolean b3,
        ...
        // as many as possible from the following expression; 
    ...
    static void work03UseOfUtilityClass() {
        System.out.println("BMI: " + MyUtill.calculateBMI(90, 1.78));
        System.out.println("AVG: " + MyUtill.average(10, 20, 30));
        /*
    ...
    static void work04UseOfObjectClass() {
        Person Jarad = new Person(999);
        Person Anthony= new Person(666);
        BankAccount bank1 = new BankAccount(999,Jarad);
        BankAccount bank2 = new BankAccount(666,Anthony);
        System.out.println("Jarad ID" + Jarad.getId());
        bank1.deposit(999);
        System.out.println("JaradBank Updated Account Balance after Deposit: " + bank1.getBalance());
        bank1.withdraw(333);
        System.out.println("JaradBank Updated Account Balance after Withdraw: " + bank1.getBalance());
        System.out.println("Anthony ID" + Anthony.getId());
        bank2.deposit(1000);
        System.out.println("AnthonyBank Updated Account Balance after Deposit: " + bank2.getBalance());
        bank2.withdraw(400);
        System.out.println("AnthonyBank Updated Account Balance after Withdraw: " + bank2.getBalance());
        
        System.out.println("#####Update balance#####");
        bank1.transfer(333, bank2);
        System.out.println("JaradBank Updated Account Balance after trasnfer: " + bank1.getBalance());
        System.out.println("AnthonyBank Updated Account Balance after trasnfer: " + bank2.getBalance());
